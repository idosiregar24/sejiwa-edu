  ...
  <div class="content">
    ...
    <main class="container mx-auto my-8 px-8">
      <div class="text-gray-500 text-sm mb-2">
        Pages / User / <span class="text-gray-800 font-semibold">Tambah Pengguna</span>
      </div>
      ...
      <div class="bg-white shadow-lg p-8 rounded-lg">
        <form action="<?= base_url('user/store') ?>" method="post">
          ...
          <div class="flex justify-end">
            <a href="<?= base_url('user') ?>" class="bg-gray-400 text-white py-2 px-4 rounded-lg hover:bg-gray-500 transition">Batal</a>
            <button type="submit" class="bg-pink-500 text-white py-2 px-4 rounded-lg hover:bg-pink-600 transition ml-2">Simpan</button>
          </div>
        </form>
