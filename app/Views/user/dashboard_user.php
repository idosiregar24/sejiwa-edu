          ...
          <?php foreach ($videos as $video): ?>
            <a href="<?= base_url('content/view/' . $video['id']) ?>" class="text-decoration-none text-dark"
              ...
              <div class="card shadow-sm h-100 rounded-3 overflow-hidden">
                <img src="<?= base_url($video['thumbnail'] ?? 'assets/img/default-thumbnail.jpg') ?>" class="card-img-top"
  ...
  <div class="row">
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100 border-0">
        <img src="<?= base_url('assets/img/artikel1.png') ?>" class="card-img-top" alt="Kesehatan Mental">
        <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100 border-0">
        <img src="<?= base_url('assets/img/artikel2.png') ?>" class="card-img-top" alt="Gizi Seimbang">
        <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100 border-0">
        <img src="<?= base_url('assets/img/artikel3.png') ?>" class="card-img-top" alt="Tidur Berkualitas">
        <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100 border-0">
        <img src="<?= base_url('assets/img/ilustrasi_relaksasi.svg') ?>" class="card-img-top" alt="Olahraga Ringan">
        <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100 border-0">
        <img src="<?= base_url('assets/img/ilustrasi_sumber_daya.svg') ?>" class="card-img-top" alt="Hidrasi Tubuh">
        <div class="card-body">
